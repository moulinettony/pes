  ...
  return (
    <div className="bg-[#030a0e]">
      <div className="pt-20 text-white text-center">
        ...
        >
          <option className="text-black" value="5_12_24">
            5 Dec 2024
          </option>
          <option className="text-black" value="6_12_24">
            6 Dec 2024
          </option>
          <option className="text-black" value="11_12_24">
            11 Dec 2024
          </option>
          <option className="text-black" value="25_12_24">
            25 Dec 2024
          </option>
        </select>
      </div>
